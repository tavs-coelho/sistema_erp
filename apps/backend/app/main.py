...
from .routers import accounting, almoxarifado, auth, budget, conciliacao, convenios, core, employee_portal, frota, hr, nfse_itbi, patrimony, ponto, procurement, protocolo, public, relatorios, rreo_rgf, tributario
